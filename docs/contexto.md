...
A escolha de solução tecnológica pouco eficaz para gerenciamento de consultas torna o fluxo de agendamentos ineficiente e propenso a erros. Além disso, a opção por uma plataforma com baixo nível de integração dificulta a comunicação entre diferentes partes envolvidas no processo, como médicos, secretários e pacientes. Além disso, a descentralização da informação pode resultar em perda de dados, agendamentos duplicados ou esquecidos, e dificuldades na organização de horários e recursos.
...
A população global está envelhecendo rapidamente. Conforme a ONU (2025), o número de pessoas com mais de 60 anos deve quase dobrar até 2050, passando de 12% para 22% da população mundial. Este fenômeno é observado tanto em países desenvolvidos quanto em desenvolvimento, refletindo melhorias na qualidade de vida e na saúde, além da redução nas taxas de fecundidade (SCIELO, 2025). Segundo a Wikipedia (2025), estima-se que, em 2017, 962 milhões de pessoas tinham 60 anos ou mais, representando 13% da população mundial. 

Há, em face disso, uma crescente demanda por consultas médicas. Segundo o Instituto de Estudos para Políticas de Saúde (IEPS, 2023), o envelhecimento da população brasileira exige adaptações no sistema de saúde para atender ao aumento da demanda por serviços médicos. Essa pressão adicional sobre os sistemas de saúde resulta em um aumento no número de consultas, sobrecarregando os métodos tradicionais de agendamento e gerenciamento. Um sistema automatizado e distribuído é essencial para lidar com esse volume crescente de consultas de maneira eficiente.
...
Por sua vez, o tempo é um recurso valioso tanto para pacientes quanto para profissionais de saúde. Um sistema de agendamento distribuído otimiza o tempo ao proporcionar uma organização clara e acessível dos horários, reduzindo esperas e melhorando a gestão dos recursos disponíveis. Destarte, com o avanço das tecnologias de informação e comunicação, os pacientes esperam poder acessar serviços de saúde de maneira rápida e conveniente por meio de dispositivos móveis e plataformas digitais. 

Portanto, o desenvolvimento da MedAgenda não é apenas uma resposta aos desafios atuais, mas uma oportunidade de revolucionar a forma como os agendamentos de consultas e procedimentos médicos são gerenciados, proporcionando benefícios significativos para todos os envolvidos. 
...
|------|-----------------------------------------|----|
|RF-001| Permitir que usuários (pacientes e médicos) realizem cadastro e login | ALTA | (Diego e Sílvia)
|RF-002| Permitir que médicos cadastrem suas agendas | ALTA | (Breno)
|RF-003| Possibilitar que o paciente agende, altere e remova consultas | ALTA | (Samara e Rodrigo)
|RF-004| Gerar relatórios de consultas agendadas | BAIXA | (Maurício)
...
- Cadastro de usuários: permite que os usuários façam os respectivos cadastros, com login e senha para acesso aos serviços. 
- Marcação, alteração e cancelamento de Consultas: permite que os pacientes e médicos gerenciem consultas agendadas diretamente pelo aplicativo ou site.
- Registro de Consultas: Manutenção de um histórico completo das consultas anteriores dos pacientes.
- Gerenciamento de agendas: possibilita ao médico o controle dos dias e horários nos quais as consultas e procedimentos poderão ser agendados. 
...
ONU. Envelhecimento. Disponível em: https://unric.org/pt/envelhecimento/. Acesso em: 25 fev. 2025.
WIKIPEDIA. Relatório Mundial de Envelhecimento e Saúde. Disponível em: https://pt.wikipedia.org/wiki/Relat%C3%B3rio_Mundial_de_Envelhecimento_e_Sa%C3%BAde. Acesso em: 25 fev. 2025.
SCIELO. Envelhecimento Populacional e Saúde: Desafios e Oportunidades. Disponível em: https://www.scielo.br/j/rsp/a/RRbSJj3PsLtCXyLPqzTJh6Q/?lang=pt. Acesso em: 25 fev. 2025.
INSTITUTO DE ESTUDOS PARA POLÍTICAS DE SAÚDE (IEPS). O envelhecimento da população e seus desafios para o sistema de saúde. 2023. Disponível em: https://ieps.org.br/estudo-institucional-10/. Acesso em: 25 fev. 2025.

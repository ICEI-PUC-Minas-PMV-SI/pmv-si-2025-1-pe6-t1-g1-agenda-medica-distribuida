        ...
        <div className='flex items-center gap-4'>
            {
                ...
                ? <div className='flex items-center gap-2 cursor-pointer group relative'>
                    {userData?.userImage ? (
                        <img className='w-8 h-8 rounded-full object-cover' src={userData.userImage} alt="profile" />
                    ) : (
                        <UserAvatar name={userData?.name} size="sm" />
                    )}
                    ...
                    <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                        <div className='min-w-48 border-t bg-stone-100 rounded flex flex-col gap-4 p-4'>
                            ...
                            <p onClick={onLogout} className='hover:text-black cursor-pointer'>Sair</p>
                        </div>
                    </div>
                </div>
